...
public class Blog {
    ...
    private boolean appreciation; // 博客赞赏开启选项
    private boolean shareStatement; // 博客转载声明开启选项
    private boolean commentable; //博客评论开启选项
    private boolean published; // 博客发布开启选项
    private boolean recommend; // 博客推荐开启选项
